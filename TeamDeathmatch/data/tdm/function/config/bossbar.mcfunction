...
# Modify Green Team Bossbar

bossbar set green color green
bossbar set green style notched_10
bossbar set green value 0
...
bossbar set respawn max 600
bossbar set respawn value 600